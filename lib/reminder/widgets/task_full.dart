...
import 'package:expensemanager/reminder/views/edit_task.dart';
import 'package:expensemanager/reminder/data/reminder.dart';

class Task extends StatelessWidget {
  final Reminder _remainder;
  final String _taskName;
  final String _whenToRepeat;
  final Color _color;
  final Color _accentColor;

  Task(this._remainder, this._taskName, this._whenToRepeat, this._color,
      this._accentColor);
    ...
    return Material(
      ...
      child: Container(
        ...
        child: InkWell(
          ...
          // onTap: () => print('Ма Батка хха'),
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => EditTask(_remainder),
                    maintainState: false));
          },
          child: Container(
