...
class expenseManagerOverview extends StatelessWidget {
  const expenseManagerOverview({
    Key key,
  }) : super(key: key);
            ...
            children: <Widget>[
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      S.of(context).expenseManagerOverviewTextBalanceHeading,
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.white,
                    ...
                    (user.budget != null)
                        ? Text(
                            S.of(context).expenseManagerOverviewTextBudgetSet(
                        ...
                        : Text(
                            S.of(context).expenseManagerOverviewTextBudgetUnset,
                            style: TextStyle(
                              fontSize: 12,
                              color: Colors.white,
                              fontWeight: FontWeight.w500,
