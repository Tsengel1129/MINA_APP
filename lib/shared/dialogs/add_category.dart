...
class AddCategoryDialog extends StatefulWidget {
  ...
  AddCategoryDialog(this.type, this.s);
...
class _AddCategoryDialogState extends State<AddCategoryDialog> {
  ...
  Widget build(BuildContext context) {
                    ...
                    Container(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            S
                                .of(context)
                                .addCategoryBottomSheetLabelTextCategoryIcon,
                            style: TextStyle(
                                fontSize: 20.0,
                                color: Colors.blue,
                                fontWeight: FontWeight
    ...
    if (widget.s == S.of(context).categoriesLabelTextCategoryTypeNecessary) {
      return Container(
        height: MediaQuery.of(context).size.height * 0.9,
        margin: EdgeInsets.only(
          bottom: MediaQuery.of(context).viewInsets.bottom,
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            S.of(context).walletBottomSheetType,
                            style: TextStyle(
                                fontSize: 20.0,
                                color: Colors.blue,
                                fontWeight: FontWeight
    ...
    if (widget.s == S.of(context).categoriesLabelTextCategoryTypeAppearance) {
      return Container(
        height: MediaQuery.of(context).size.height * 0.9,
        margin: EdgeInsets.only(
          bottom: MediaQuery.of(context).viewInsets.bottom,
