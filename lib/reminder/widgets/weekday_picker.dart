...
class WeekdayPicker extends StatefulWidget {
  ...
  int getNumberOfEnabledDays() {
    ...
    for (int i = 0; i < enabledDays.length; i++) {
      if (enabledDays[i] == true) numEnabled++;
    }
    return numEnabled;
  }
  ...
  String getWeekdayString() {
    ...
    if (numEnabled > 3 && numEnabled < 7) {
      //To prevent overflow on smaller devices, make the weekday text an acronym
      ...
      if (enabledDays.every((e) => e == true))
        return 'Every day'; //If all days are enabled return a cleaner string
