...
class _ExportDialogState extends State<ExportDialog> {
  ...
  Future beginExport(User user) async {
    ...
    var url =
        'https://us-central1-be-expensemanager-today.cloudfunctions.net/export/$format?uid=${user.uid}&startDate=${startDate.toIso8601String()}&endDate=${endDate.toIso8601String()}';
