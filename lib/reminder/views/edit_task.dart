...
class _EditTaskState extends State<EditTask> {
  ...
  Widget dateText() {
    if (this.picked == null) {
      return Padding(
        ...
        child: Text("Өдөр сонгоогүй байна"),
      );
    }
    return Padding(
      padding: EdgeInsets.only(right: 10.0),
  ...
  void initState() {
    ...
    _choiceChipValue = _remainder
        .reminderType; //Set to 0, so that the weekday chip is enabled by default
    ...
    _timeFromPicker = TimeOfDay(
        hour: _remainder.reminderTime.hour,
        minute: _remainder.reminderTime.minute);
    _repeatEveryNumber = _remainder.repeatEvery;
    _whenToRepeat = _remainder.specificDate;
    _controllerRepeatEvery =
        new TextEditingController(text: _remainder.repeatEvery.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Сануулагчийг засварлах'),
        ...
        body: new Padding(
          ...
          child: ListView(
            children: <Widget>[
              ...
              //   child: TaskCard(_currentTaskName, _currentTaskSubText,
              //       _previewCardColor, _previewCardAccent),
              // ),
              Padding(
                      ...
                      onPressed: !(_currentTaskSubTextNoTime.length >
                          ...
                          : () async {
                              ...
                              var newReminder = Reminder(
                                  ...
                                  _whenToRepeat,
                                  getReminderTime(),
                                  _notificationIdPrevious);
                              reminders.removeWhere((remind) =>
                                  remind.notificationID ==
                                  _notificationIdPrevious);
